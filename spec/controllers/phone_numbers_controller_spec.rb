...
describe PhoneNumbersController do
  ...
  #       post :create, {:phone_number => {}}, valid_session
  #       assigns(:phone_number).should be_a_new(PhoneNumber)
  #     end
  ...
  #       PhoneNumber.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  #       put :update, {:id => phone_number.to_param, :phone_number => {'these' => 'params'}}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       PhoneNumber.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => phone_number.to_param, :phone_number => {}}, valid_session
  #       assigns(:phone_number).should eq(phone_number)
  #     end
